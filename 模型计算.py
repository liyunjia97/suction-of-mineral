...
def train_result_plot(force,machine_model):
    ...
    DF_test,mse_data_mean,mae_data_mean,me_data_mean,relative_error_data_mean,\
    mse_test_mean,mae_test_mean,me_test_mean,relative_error_test_mean=training_11_fold(DF,df_minmax,force,machine_model)
    ...
    print('训练集置信度:',relative_error_data_mean)
    print('测试集置信度:',relative_error_test_mean)
...
def train_result_contras_plot(force):
    ...
    DF_test_polynomial, mse_data_mean_polynomial, mae_data_mean_polynomial, me_data_mean_polynomial, \
    mse_test_mean_polynomial, mae_test_mean_polynomial, me_test_mean_polynomial = training_11_fold(
        DF, df_minmax, force, 'polynomial')
    DF_test_nn, mse_data_mean_nn, mae_data_mean_nn, me_data_mean_nn, mse_test_mean_nn,\
    mae_test_mean_nn, me_test_mean_nn = training_11_fold(
