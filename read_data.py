...
def read_data():
    ...
    '''
    dfL=pd.read_csv('D:\WORK_DATA_F\jupyter_notebook\赵国成\论文撰写代码准备\数据过滤结果0414\L整体数据0414修改.csv',index_col=0)
    dfL.columns=['y/d','x/d','CFr','CFv']
    dfL=dfL[['x/d','y/d','CFr','CFv']]
    dfL['y/d']=dfL['y/d']+0.5
    dfH=pd.read_csv('D:\WORK_DATA_F\jupyter_notebook\赵国成\论文撰写代码准备\H整体数据.csv',index_col=0)
    dfH['y/d'] = dfH['y/d'] + 0.5
